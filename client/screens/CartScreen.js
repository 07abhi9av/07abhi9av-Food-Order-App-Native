  ...
  return (
    <View className="bg-white flex-1 top-10">
        ...
        <View className="relative py-4 shadow-sm">
            <TouchableOpacity style={{backgroundColor: themeColors.bgColor(1)}} onPress={() => navigation.goBack()} className="absolute z-10 rounded-full p-1 shadow top-5 left-5">
        ...
        {/* totals */}
        <View style={{backgroundColor: themeColors.bgColor(0.2)}} className="bottom-10 p-6 px-8 rounded-t-3xl space-y-4">
